...
public class HeadResponse extends HttpResponse {
	...
	public static HttpResponse get200(File file, String connection) {
		HttpResponse response = new HeadResponse(Protocol.VERSION, Protocol.OK_CODE, 
	...
	public static HttpResponse get404(String connection) {
		HttpResponse response = new HeadResponse(Protocol.VERSION, Protocol.NOT_FOUND_CODE, 
