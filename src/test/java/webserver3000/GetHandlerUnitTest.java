...
public class GetHandlerUnitTest {
	...
	@Test
	public void testHandleGetDirectoryNoDefault() throws InterruptedException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, IOException {
	...
	@Test
	public void testHandleGetDirectoryWithDefault() throws InterruptedException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, IOException {
		File newDir = new File(root, "test");
		newDir.mkdir();
	...
	@Test
	public void testHandleGetFile() throws InterruptedException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
